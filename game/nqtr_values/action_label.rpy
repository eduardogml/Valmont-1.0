...
label map_doors_setup:
    $ actions["wing_west_entrance_door"] = Act(name = _("WING WEST HALL"),  picture_in_background = "images/location/wing_west_entrance-door-[tm.timeslot_number].webp", label_name = "wing_west_entrance_door", room_ids=['west_wing_campus_entrance'],
        xalign = 716/1920, yalign = 650/1080)
    return
